...
class BaseTrainer:
            ...
            for i, batch in pbar:
                ...
                with autocast(self.amp):
                    ...
                    if self.args.compile:
                        ...
                        model_input = (batch["img"], batch["depth_img"]) if "depth_img" in batch else batch["img"]
    ...
    def build_optimizer(self, model, name="auto", lr=0.001, momentum=0.9, decay=1e-5, iterations=1e5):
        ...
        """
        g, gd = ([], [], []), ([], [], [])  # optimizer parameter groups, DINOBackbone parameter groups
        ...
        if any(gd):
            ...
            if gd[0]:
                optimizer.add_param_group({"params": gd[0], "lr": dino_lr, "weight_decay": decay})
            if gd[1]:
                optimizer.add_param_group({"params": gd[1], "lr": dino_lr, "weight_decay": 0.0})
        LOGGER.info(
